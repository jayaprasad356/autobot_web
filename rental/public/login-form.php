...
if (isset($_POST['btnLogin'])) {
    ...
    if (!empty($mobile) && !empty($password)) {
        ...
        $sql_query = "SELECT * FROM `rental_showrooms` WHERE mobile = '" . $mobile . "' AND password = '" . $password . "'";
...
<div class="col-md-4 col-md-offset-4 " style="margin-top:80px;">
    <div class='row'>
        <div class="col-md-12 text-center">
            ...
            <h3>Rentals  Dashboard</h3>
        </div>
        <div class="box box-info col-md-12">
            <div class="box-header with-border">
                <h3 class="box-title">Rental Showroom Login</h3>
            </div>
            <form method="post" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="box-footer">
                        <a href="sign-up.php" class="btn pull-left">Create New Account?</a>
