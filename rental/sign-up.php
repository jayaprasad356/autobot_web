...
<head>
    ...
    <title>Rental Showroom Registration - Autobot</title>
    ...
    <div class="col-md-4 col-md-offset-4 " style="margin-top:5px;">
        ...
        <div class='row'>
            <div class="col-md-12 text-center">
                ...
                <h3>Rentalshowrooms Registration form</h3>
            </div>
            <div class="box box-primary col-md-12">
                <!-- form start -->
                <form method="post" action="public/db-operation.php" id="add_rental_form" enctype="multipart/form-data">
                    <input type="hidden" id="add_rental_showroom" name="add_rental_showroom" required="" value="1" aria-required="true">
                    <div class="box-body">
...
<script>
    $('#add_rental_form').on('submit', function(e) {
        e.preventDefault();
        var formData = new FormData(this);
        if ($("#add_rental_form").validate().form()) {
            $.ajax({
                type: 'POST',
